...
<html>
	...
	<div class = "isi1">
		...
		<form method="POST" action="SimpanEkskul.php">
		<table class="tabel6">
			<tr for = "Nama">
				<td>Nama Lengkap </td>
		...
		<table class = "tabel8">
			<tr>
			<td><center><b>Ketentuan Ekstrakulikuler <b></center></td>
			</tr>
		</table>		
		...
		<table class = "tabel9">
			<tr>
			<td><justify>
				1. Siswa - siswi yang mendaftar ekstrakurikuler wajib sepengetahuan 
				orang tua 
				<br>
				2. Peserta ekstrakurikuler wajib mengikuti peraturan ekstrakurikuler
				<br>
				3. Seluruh siswa - siswi kelas X-XI wajib mengikuti ekstrakurikuler 
			    Pendidikan Kepramukaan 
				<br>
				4. Seluruh siswa - siswi X-XI hanya mengikuti maksimal 2 ekstrakurikuler
				pilihan</justify></td>
			</tr>
		</table>				
		...
		<tr>
				<td>
				<a href="beranda.php"><input type="submit" class="Input-btn" name="back" value="Back"/></a>
				</td>
			</tr>
